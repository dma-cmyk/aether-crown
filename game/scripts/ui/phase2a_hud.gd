extends CanvasLayer
## Phase 2A city-war HUD: same top bar / selection / production / end-screen
## as match_hud.gd, but the outpost box is replaced by a cities box showing
## ownership counts plus one status line per city. Phase 1.5 HUD untouched.
